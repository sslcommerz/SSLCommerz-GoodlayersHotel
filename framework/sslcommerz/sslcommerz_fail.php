	...
	// print_r($_POST);exit;
	 $payment_info = array(
		...
		$wpdb->update( $wpdb->prefix . 'gdlr_hotel_payment', 
			array('payment_status'=>'fail', 'payment_info'=>serialize($payment_info), 'payment_date'=>date('Y-m-d H:i:s')), 
		...
		<table>
			<tr>
				<th colspan="4" align="center">Payment Failed</th>
			</tr>
			<tr>
